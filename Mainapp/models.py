from django.db import models #(username=MohdJafar,Password=Jafar123)
...
class Buyer(models.Model):
    ...
    pic5=models.ImageField(upload_to="uploads",default="",null=True, blank=True)
    otp=models.IntegerField(default=-767868768)
    def __str__(self):
...
status=((0,"Order Place"),(1,"Not Packed"),(2,"Packed"),(3,"Ready To Shipped"),(4,"Shipped"),(5,"Out For Delivery"),(6,"Delivered"),(7,"Cancelled"))    
...
class Contact(models.Model):
    ...
    status=models.IntegerField(choices=subjectStatus,default=0)
    date=models.DateTimeField(auto_now=True)
